...
import { type ExperiencesTableProps } from '../types'
import { DataTableBulkActions } from './data-table-bulk-actions'
import { experiencesColumns as columns } from './experiences-columns'

const route = getRouteApi('/_authenticated/experiences/')

export function ExperiencesTable({ data }: ExperiencesTableProps) {
  ...
  const table = useReactTable({
    ...
    globalFilterFn: (row, _columnId, filterValue) => {
      ...
      const skills = (row.original.skills || []).join(' ').toLowerCase()
